...
import os   
TAG='/home/www_adm/ssd/CHIP_OUTPUT/BLAST_FASTA_VIRUS'
shutil.rmtree(TAG, ignore_errors=True)
os.mkdir(TAG)
    
csv_database = create_engine('sqlite:////home/www_adm/ssd/CHIP_OUTPUT/STEP_01_VIRUS.db')       
...
for CK in range(0,len(SX)):
    ...
    for s,ids in zip(seq,idx):
        ...
        rec_list.append(rec)    
        c=c+1
    SeqIO.write(rec_list, '/home/www_adm/ssd/CHIP_OUTPUT/BLAST_FASTA_VIRUS/' + str(CK) + '.fasta', "fasta")            
