...
def gen_fast(param):
    G=param
    input_fasta='/home/www_adm/ssd/CHIP_OUTPUT/BLAST_FASTA/' + str(G) + '.fasta'
    input_base='/home/www_adm/ssd/BLAST/REFSEQ_DB/refseq_rna'
    output_report='/home/www_adm/ssd/CHIP_OUTPUT/BLAST_REPORT/' + str(G) + '.report'
    cmd='blastn -task megablast -word_size 16 -ungapped -qcov_hsp_perc 75 -perc_identity 100 -gilist /home/www_adm/ssd/BLAST/seq_new.gi -db '+ input_base + ' -query '+ input_fasta + ' -out ' + output_report + ' -outfmt "6 qseqid qstart qend qseq sseqid sstart send length mismatch gaps pident nident" -num_threads 1'
...
csv_database = create_engine('sqlite:////home/www_adm/ssd/CHIP_OUTPUT/STEP_02.db')       
dfa=[1,1,1,'sss','aaa',1,1,1,1,1,1,1]
...
number_files = len(os.listdir('/home/www_adm/ssd/CHIP_OUTPUT/BLAST_FASTA/'))
